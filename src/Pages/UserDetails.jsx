...
import UserRepositoriesList from "../Components/Users/UserRepositoriesList";
/* Importing Local Components Ends */

const UserDetails = () => {
  const { dispatch, userDetails, isLoading, repos } = useContext(GithubContext);
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      dispatch({ type: "GET_USER_DETAILS", payload: userAndRepos });
    })();
  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <UserRepositoriesList repoList={repos} />
      </div>
    </>
  );
};
